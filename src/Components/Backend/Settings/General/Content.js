...
const Content = ({ attributes, setAttributes, activeFeature, setActiveFeature }) => {
  ...
  return (
    <div>
      <PanelBody title={__("Content Setting", "b-blocks")}>
        {
              ...
              <>
                <div key={index} className='feature'>
                  ...
                  <div className='icons'>
                    ...
                    {
                      items.length > 1 && <Button className='dlt-btn' onClick={() => deleteItem(activeFeature)} icon={"trash"}></Button>
                    }
                  </div>
                </div>
        ...
        {/* Title HTML Tag */}
        <SelectControl
          label={__("Title HTML Tag", "b-blocks")}
        ...
        {/* Show Icon or Not */}
        <ToggleControl
          label={__("Display Icon", "b-blocks")}
            ...
            <>
              ...
              <div className="icon-position-tab-content">
                ...
                <div className={`icon-position-tab-item ${valueForEachItem.iconPosition === 'left' ? 'activeIconPosition' : ''}`}>
                  ...
                  <ToggleControl
                    label={__("Content Vertically Center", "b-blocks")}
                  ...
                  {/* Show Connector Line */}
                  {
                    !valueForEachItem.useInlineFeatures && (
                      <>
                        <ToggleControl
                          label={__("Show Connector Line", "b-blocks")}
                        ...
                        {/* Connector Line Color */}
                        {
                          valueForEachItem.showConnectorLine && <div style={{ margin: "10px 0" }}>
                            <BColor
                              label={__('Connector Line Color', 'b-blocks')}
                        ...
                        {/* Connector Line Width */}
                        {
                          valueForEachItem.showConnectorLine && <div>
                            <RangeControl
                              label={__("Connector Line Width", "b-blocks")}
